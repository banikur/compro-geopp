      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-steel leading-relaxed text-sm max-w-sm mb-8">
            ...
            <div className="space-y-3">
              ...
              >
                <Mail className="w-4 h-4 text-steel group-hover:text-sky transition-colors" />
          ...
          <div className="lg:col-span-4 space-y-8">
            <div>
              <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-sky" /> Kantor Pusat
              </h4>
              <address className="not-italic text-steel leading-relaxed text-sm">
              ...
              <a href="tel:081328259928" className="mt-2 flex items-center gap-2 text-sm hover:text-white transition-colors font-mono">
                <Phone className="w-3.5 h-3.5 text-steel" /> 0813-2825-9928
              </a>
            </div>
            <div>
              <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-sky" /> Workshop Operasional
              </h4>
              <address className="not-italic text-steel leading-relaxed text-sm">
              ...
              <a href="tel:081317688191" className="mt-2 flex items-center gap-2 text-sm hover:text-white transition-colors font-mono">
                <Phone className="w-3.5 h-3.5 text-steel" /> 0813-1768-8191
              </a>
            </div>
          </div>
        </div>

        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-steel">
